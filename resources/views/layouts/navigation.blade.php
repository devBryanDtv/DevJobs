        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('home.index')" :active="request()->routeIs('home.index')">
                    ...
                    <x-nav-link :href="route('home.mapa')" :active="request()->routeIs('home.mapa')">
                        {{ __('Mapa') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('adminprofile.index')" :active="request()->routeIs('adminprofile.index')">
                        {{ __('Administrador de Perfiles') }}
                    </x-nav-link>
                </div>
                    @endauth
